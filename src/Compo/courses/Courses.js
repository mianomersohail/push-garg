        ...
        <div className='row'>
          ...
          <div className="col-lg-3">
            <div className="course-box">
              ...
              <p className="course-p-one">"I built a cutting-edge portfolio website with the latest tools and technologies, following top coding best practices. The site is seamlessly connected to a Node.js backend.For such Amazing features."
                .</p>
              <button className="courses-github-btn">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
